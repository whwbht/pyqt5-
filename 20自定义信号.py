...
class MyWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # 创建一个滚动对象
        scroll = QScrollArea()
        scroll.setWidget(self.msg)#设置对msg滚动？

        # 创建垂直布局器，用来添加自动滚动条
        v_layout = QVBoxLayout()
        v_layout.addWidget(scroll)#滚动一般配合布局器使用
    ...
    def my_slot(self, msg):
        ...
        self.msg.setText("<br>".join(self.msg_history))#字符串连接内容 html语法规则
        self.msg.resize(700, self.msg.frameSize().height() + 15)#扩区 显示 700宽度
